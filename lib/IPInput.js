...
export function IPInput(props) {
    var validators = props.validators, otherProps = __rest(props, ["validators"]);
    var allValidators = __spreadArrays([ipAddress()], (validators || []));
    return React.createElement(FormInput, __assign({}, otherProps, { validators: allValidators }));
}
